    ...
    <Grid container spacing={2}>
      <Grid size={{ xs: 12, md: 4 }}>
        <Box sx={sx.statCard(green[50])}>
          ...
          <Typography variant="h4" sx={{ color: green[700], fontWeight: 600, mt: 1 }}>
      ...
      <Grid size={{ xs: 12, md: 4 }}>
        <Box sx={sx.statCard(red[50])}>
          <Box sx={sx.statHeader}>
            <TrendingDown sx={{ color: red[600], fontSize: 20 }} />
            <Typography variant="caption" sx={{ color: 'text.secondary', ml: 1 }}>
              Total Expenses
            </Typography>
          </Box>
          <Typography variant="h4" sx={{ color: red[700], fontWeight: 600, mt: 1 }}>
      ...
      <Grid size={{ xs: 12, md: 4 }}>
        <Box sx={sx.statCard(blue[50])}>
          <Box sx={sx.statHeader}>
            <AccountBalance sx={{ color: blue[600], fontSize: 20 }} />
            <Typography variant="caption" sx={{ color: 'text.secondary', ml: 1 }}>
              Net Profit
            </Typography>
          </Box>
          <Typography variant="h4" sx={{ color: blue[700], fontWeight: 600, mt: 1 }}>
