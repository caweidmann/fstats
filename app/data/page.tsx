...
import { formatFileSize, useFileUpload, useIsDarkMode, useIsMobile, useLocalSettings, useUserPreferences } from '@/hooks'
...
const Page = () => {
  ...
  const { selectedFileIds, set } = useLocalSettings()
