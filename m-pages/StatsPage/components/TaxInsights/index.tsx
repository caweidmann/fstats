...
import { DEMO_TAX_INSIGHTS } from '../../demo-data'
import type { OptimizationInsight } from '../../demo-data'
import { ui } from './styled'

type TaxInsightsProps = {
  transactions: ParsedContentRow[]
  isDemoMode: boolean
}

const Component = ({ transactions, isDemoMode }: TaxInsightsProps) => {
  ...
  return (
    <Card sx={{ borderRadius: 2 }}>
      ...
      {expanded ? (
        <Box sx={{ mt: 3, px: 3, pb: isDemoMode ? 3 : 1 }}>
          {!isDemoMode ? (
            <Alert severity="info" icon={<Lightbulb />} sx={{ borderRadius: 1.75, p: 2 }}>
              ...
              <Typography variant="caption" sx={{ color: 'text.secondary' }}>
                {`We're`} working on intelligent tax optimisation recommendations based on your actual transactions.
                This feature will analyse your spending patterns and suggest ways to maximise your tax deductions.
              </Typography>
            </Alert>
          ) : (
            <>
